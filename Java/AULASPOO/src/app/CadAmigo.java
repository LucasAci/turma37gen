...
public class CadAmigo {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite 1-masculino, 2-femilina, 3-neutre: ");
		...
		System.out.printf("Bom dia Sr%c.%s, sua idade é %d anos.\n",cad1.pronome,cad1.nome.toUpperCase(),cad1.cacularIdade(2021));
